...
PROJECT_CONFIG_KEYS=(
  ...
  PROXY GITHUB_MIRROR HUGGINGFACE_MIRROR SNAPSHOT_PATH HOTPATCHER_PORT
  EXTRA_INSTALL_ARGS RESTORE_FROM_SNAPSHOT DISABLE_SNAPSHOT
  DISABLE_HOTPATCHER ENABLE_HOTPATCHER_RUNTIME DISABLE_PYPI_MIRROR
  DISABLE_AUTO_MIRROR DISABLE_PROXY DISABLE_UV DISABLE_GITHUB_MIRROR
