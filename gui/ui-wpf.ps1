...
function Export-GuiEventFunctions {
    $names = @(
        "Append-UiLog", "Confirm-Message", "Enable-WindowsLongPathsElevated", "Get-CurrentPowerShellExecutable", "Get-GuiXamlPath", "Load-GuiXamlWindow", "Set-ThemeResources", "Apply-DiscoveredInstallTarget", "Apply-HeroImage", "AutoSave-MainConfigFromUi", "Ensure-GuiState", "Get-CurrentProjectKey", "Get-DefaultInstallDiscoveryRoots", "Get-DefaultMainConfig", "Get-DefaultProjectConfig", "Get-EffectiveInstallPath", "Get-InstallDiscoveryFeatureRows", "Get-ObjectPropertyValue", "Get-ProjectConfig", "Get-ScriptExtraArgs",
