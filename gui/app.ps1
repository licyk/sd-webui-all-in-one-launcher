...
function Start-App {
    ...
    $UI = [PSCustomObject]@{
        ...
        StartModeTabs = $window.FindName("StartModeTabs"); LaunchScriptList = $window.FindName("LaunchScriptList"); UnifiedStartBtn = $window.FindName("UnifiedStartBtn"); UnifiedStartLabel = $window.FindName("UnifiedStartLabel"); StartProgressBar = $window.FindName("StartProgressBar"); TerminateOperationBtn = $window.FindName("TerminateOperationBtn"); TerminateStopIcon = $window.FindName("TerminateStopIcon"); TerminateBusyIcon = $window.FindName("TerminateBusyIcon"); TerminateOperationLabel = $window.FindName("TerminateOperationLabel"); StartHintText = $window.FindName("StartHintText"); InstallHintText = $window.FindName("InstallHintText")
