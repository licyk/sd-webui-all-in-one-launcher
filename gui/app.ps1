...
function Start-App {
    ...
    $UI = [PSCustomObject]@{
        ...
        PathPanel = $window.FindName("PathPanel"); ConfigPanel = $window.FindName("ConfigPanel"); ResetInstallerConfigBtn = $window.FindName("ResetInstallerConfigBtn")
        ...
        ScriptCombo = $window.FindName("ScriptCombo"); ResetCurrentScriptConfigBtn = $window.FindName("ResetCurrentScriptConfigBtn"); ScriptParamPanel = $window.FindName("ScriptParamPanel"); ScriptArgsBox = $window.FindName("ScriptArgsBox")
        StartModeTabs = $window.FindName("StartModeTabs"); LaunchScriptList = $window.FindName("LaunchScriptList"); UnifiedStartBtn = $window.FindName("UnifiedStartBtn"); UnifiedStartLabel = $window.FindName("UnifiedStartLabel"); StartProgressBar = $window.FindName("StartProgressBar"); TerminateOperationBtn = $window.FindName("TerminateOperationBtn"); TerminateStopIcon = $window.FindName("TerminateStopIcon"); TerminateOperationLabel = $window.FindName("TerminateOperationLabel"); TerminateProgressBar = $window.FindName("TerminateProgressBar"); StartHintText = $window.FindName("StartHintText"); InstallHintText = $window.FindName("InstallHintText")
        ...
        CheckUpdateBtn = $window.FindName("CheckUpdateBtn"); ResetMainConfigBtn = $window.FindName("ResetMainConfigBtn"); OpenConfigFolderBtn = $window.FindName("OpenConfigFolderBtn"); OpenLogFolderBtn = $window.FindName("OpenLogFolderBtn"); OpenCacheFolderBtn = $window.FindName("OpenCacheFolderBtn"); CreateShortcutBtn = $window.FindName("CreateShortcutBtn"); UninstallLauncherBtn = $window.FindName("UninstallLauncherBtn"); UninstallBtn = $window.FindName("UninstallBtn"); UninstallIcon = $window.FindName("UninstallIcon"); UninstallLabel = $window.FindName("UninstallLabel"); UninstallProgressBar = $window.FindName("UninstallProgressBar"); OneClickNavBtn = $window.FindName("OneClickNavBtn"); AdvancedNavBtn = $window.FindName("AdvancedNavBtn"); SoftwareNavBtn = $window.FindName("SoftwareNavBtn"); SettingsNavBtn = $window.FindName("SettingsNavBtn"); AboutNavBtn = $window.FindName("AboutNavBtn"); OneClickNavLabel = $window.FindName("OneClickNavLabel"); AdvancedNavLabel = $window.FindName("AdvancedNavLabel"); SoftwareNavLabel = $window.FindName("SoftwareNavLabel"); SettingsNavLabel = $window.FindName("SettingsNavLabel"); AboutNavLabel = $window.FindName("AboutNavLabel"); OneClickNavIcon = $window.FindName("OneClickNavIcon"); AdvancedNavIcon = $window.FindName("AdvancedNavIcon"); SoftwareNavIcon = $window.FindName("SoftwareNavIcon"); SettingsNavIcon = $window.FindName("SettingsNavIcon"); AboutNavIcon = $window.FindName("AboutNavIcon"); HelpBtn = $window.FindName("HelpBtn"); ShowLogBtn = $window.FindName("ShowLogBtn"); AboutAgreementText = $window.FindName("AboutAgreementText")
    ...
    $State = [PSCustomObject]@{ CurrentOperation = $null; DiscoveryOperation = $null; UpdateOperation = $null; ShortcutOperation = $null; ConfigControls = @{}; ScriptParamControls = @{}; ProjectConfig = @{}; DiscoveredInstalls = @(); StatusRefreshTimer = $null; DiscoveryProgressTimer = $null; LastOneClickStatus = ""; IsRefreshing = $false; AutoSaveProjectConfig = $null; IsAutoSavingMainConfig = $false }
    ...
    $UI.ResetCurrentScriptConfigBtn.Add_Click({ Invoke-ResetCurrentScriptConfig $UI $State }.GetNewClosure())
